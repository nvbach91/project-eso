App.GLocaleEN = {
  ...
  "tip_gokasa_sync"                         : "Connect to OPS to enable sending orders to Gokasa Kitchen and Gokasa Quantum",
  "tip_gokasa_sync_url"                     : "Use this URL address by binding 127.0.0.1 to it in the C:/Windows/System32/drivers/etc/hosts file, e.g. sync.vcap.me 127.0.0.1",
  ...
  "tip_modifications_settings"              : "Tip: Add or edit modification by entering its number. Use a dot (.) at the end of the modification type name to make it mandatory. Use an exclamation mark (!) at the end of the modification type name to make it mandatory in takeout mode.",
