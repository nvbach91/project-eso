...
router.post('/registration', (req, res) => {
  ...
  axios.post(`https://www.google.com/recaptcha/api/siteverify?secret=${secret}&response=${response}`).then((resp) => {
    ...
    newRegister.receipt = { img: '', header: '', footer: '', extraPadding: 4, orderInitial: 0, masking: true, highlightOrderNumber: true };
    ...
    newRegister.labelPrinter = { name: '', ip: '', diacritics: true, direct: true, columns: 42, groups: '', top: 30, left: 150, fontSize: 32 };
